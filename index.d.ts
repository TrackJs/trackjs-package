...
export namespace TrackJS {
   ...
   */
  export function attempt(func: Function, context?: any, ...args: any[]): any;
   ...
   */
  export function configure(options: TrackJSConfigureOptions): boolean;
   ...
   */
  export function install(options: TrackJSInstallOptions): boolean;
   ...
   * @param {String} key
   */
  export function removeMetadata(key: string): void;
   ...
   */
  export function track(error: Error | Object | String): void;
   ...
   */
  export function watch(func: Function, context?: any): Function;
   ...
   */
  export function watchAll(obj: Object): Object;
